...
<!-- Begin Page Content -->
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <h1 class="h5 mb-0 text-dark font-weight-bold">Edit Advantage</h1>
    </div>

    {!! Form::model($advantage, ['method' => 'PATCH','route' => ['advantages.update', $advantage->id], 'files' => true]) !!}
    <div class="card shadow mb-3">
        <div class="card-body">
            <a href="{{ route('advantages.index') }}" class="btn btn-secondary btn-icon-split">
                <span class="icon">
