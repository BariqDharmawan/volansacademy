...
@section('title', 'Edit Photo Alumni Sub Class')
@section('content')
<!-- Begin Page Content -->
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <h1 class="h5 mb-0 text-dark font-weight-bold">Edit Photo ALumni Sub Class {{$photo->name}}</h1>
    </div>

	{!! Form::model($photo, ['method' => 'PATCH','route' => ['subclasses.photos.update', [$subclass->id, $photo->id]], 'files' => true]) !!}
