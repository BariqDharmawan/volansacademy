...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <h1 class="h5 mb-0 text-dark font-weight-bold">Edit Testimonial</h1>
    </div>

    {!! Form::model($testimonial, ['method' => 'PATCH','route' => ['testimonial.update', $testimonial->id]]) !!}
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::textArea('testimonial', null, array('placeholder' => 'Testimonial','class' => 'form-control mb-2')) !!}
                    </div>
                </div>
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <br>
                        <img src="{{ url('/images/'.$testimonial->image) }}" alt="Gambar Testimonial" width="400px">
                        <br>
						@endif
