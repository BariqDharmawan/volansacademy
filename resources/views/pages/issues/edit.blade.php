...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <h1 class="h5 mb-0 text-dark font-weight-bold">Edit issue #{{ $issue->id }}</h1>
    </div>

    {!! Form::model($issue, ['method' => 'PATCH','route' => ['issues.update', $issue->id], 'files' => true]) !!}
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('project_id', [null=>'Please Select'] + $projects,$issue->project_id, array('class' => 'form-control', 'id' => 'project_id')) !!}
                    </div>
                </div>
				<div class="col-xs-6 col-sm-6 col-md-6">
					<div class="form-group">
						...
						<div class="input-group date" id="date" data-target-input="nearest">
							<input type="text" name="date" style="background:white !important" placeholder="Pilih tanggal Form PM (DD/MM/YYYY)" readonly="readonly" class="form-control datetimepicker-input" data-target="#date" data-target="#date" data-toggle="datetimepicker" value="{{ date('d-m-Y', strtotime($issue->date)) }}"/>
						</div>
					</div>
				</div>
